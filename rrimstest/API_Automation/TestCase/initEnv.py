...
class initEvn():
    ...
    def test_report(self):
        conf = Config()
        env = "private_debug"
        conf.set_conf(env, "versioncode", "V1.0")
    ...
    def get_userCookie(self):
        ...
        response = self.login.login(self.host, userName="cqhj", password="DB1A8BD798EEA81B0BE3DCA1D0E2C309")
        assert self.test.assert_code(response['code'], 200)
